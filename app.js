/*** SETUP CURRENT ROOM ***/
      ...
      var customName = getAllUrlParams().name;
      ...
      /*** HANDLE ROOM CHANGE ***/
      function changeRoom() {
        var result = prompt("Enter a room id. The room will be created if it doesn't exist. An empty room id brings you back to the global room.", decodeURIComponent(room).replace(/\+/g ," "));
        if (result != null) {
      ...
      var userIp = "";
      var file = "none";
      var uniqueID = localStorage.webChatID || uuidv4();
